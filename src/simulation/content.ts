...
export const SCENARIO_CARDS: readonly ScenarioCardContent[] = [
  {
    id: 'opening',
    title: 'Working Tower Scenario',
    description: 'Act 2 pressure, daily reports, and first operating diagnosis.',
    preview: 'assets/previews/opening-desktop.png',
    actFocus: 2,
  },
  {
    id: 'skyline',
    title: 'Skyline Charter Scenario',
    description: 'Completed Acts 1-5, public memory, victory, and sandbox cycle.',
    preview: 'assets/previews/skyline-victory-desktop.png',
    actFocus: 5,
  },
  {
    id: 'weather',
    title: 'Weather Stress Scenario',
    description: 'Height risk, skyline atmosphere, and safety/code pressure.',
    preview: 'assets/previews/weather-stress-desktop.png',
    actFocus: 5,
  },
  {
    id: 'recovery',
    title: 'Recovery Drill Scenario',
    description: 'Failed public pressure converted into repair contracts.',
